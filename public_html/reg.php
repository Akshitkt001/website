...
<head>
    ...
    <title>AIET ONLINE REGISTRATION</title>
    <link rel="icon" type="image/png" href="images/AIET-logos.jpeg">
...
<body>
    ...
    <section class="contact-us">
        <div class="row">
            <div class="contact-col">
                ...
                <span>
                    <h5>NH-27,ABC , XYZ-226003</h5>
                </span>
            </div>
            <div>
                <i class="fas fa-phone"></i>
                <span>
                    <h5>522-813844, Ext. 522</h5>
                </span>
            </div>
            <div>
                <i class="fas fa-mobile"></i>
                <span>
                    <h5>88888-99999,99999-888888</h5>
                </span>
            </div>
            <div>
                <i class="fas fa-envelope"></i>
                <span>
                    <h5>info@aietcollage.ac.bd</h5>
                </span>
            </div>
            </div>
    ...
    <!--part five end-->
           ...
           <section class="footer"> 
            ...
            <p>Made by <i style="color: #ff6347;" class="far fa-lg fa-registered"></i> Akshit Kumar Tiwari</p>
           </section>
           <!--part six end-->
